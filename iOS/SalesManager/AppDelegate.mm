...
-(void)initPage{
   ...
   // UIViewController *contactsViewController = [[ContactsViewController  alloc] init];
    ...
    UIViewController *taskDownViewController = [[TaskDownViewController alloc] init];
   ...
   // _contactsNavCtrl = [[UINavigationController alloc] initWithRootViewController:contactsViewController];
    ...
    _TaskNavCtrl  =  [[UINavigationController alloc] initWithRootViewController:taskDownViewController];
...
-(void)syncData:(NSData*)syncData {
    ...
    [LOCALMANAGER saveValueToUserDefaults:KEY_COUNT_VIDEO_DURATION Value:[NSString stringWithFormat:@"%d",data.videoDurationCategories.count]];
    [LOCALMANAGER saveValueToUserDefaults:KEY_COUNT_VIDEOCATETORY Value:[NSString stringWithFormat:@"%d",data.videoCategories.count]];
    [LOCALMANAGER saveValueToUserDefaults:KEY_COUNT_INSPECTION Value:[NSString stringWithFormat:@"%d",data.inspectionTargets.count]];
    [LOCALMANAGER saveValueToUserDefaults:KEY_COUNT_CUSTOMER_CATEGORY Value:[NSString stringWithFormat:@"%d",data.customerCategories.count]];
    [LOCALMANAGER saveValueToUserDefaults:KEY_COUNT_PATROL_CATEGORY Value:[NSString stringWithFormat:@"%d",data.patrolCategories.count]];
    ...
    [LOCALMANAGER saveValueToUserDefaults:KEY_COUNT_COMPETITION_PRODUCT Value:[NSString stringWithFormat:@"%d",data.competitionProducts.count]];
    
    [LOCALMANAGER saveValueToUserDefaults:KEY_COUNT_PRODUCT Value:[NSString stringWithFormat:@"%d",data.products.count]];
    ...
    [LOCALMANAGER saveValueToUserDefaults:KEY_COUNT_DEPARTMENT Value:[NSString stringWithFormat:@"%d",data.departments.count]];
    [LOCALMANAGER saveValueToUserDefaults:KEY_COUNT_GIF_PRODUCT Value:[NSString stringWithFormat:@"%d",data.giftProducts.count]];
    [LOCALMANAGER saveValueToUserDefaults:KEY_COUNT_GIF_PRODUCT_CATEGORY Value:[NSString stringWithFormat:@"%d",data.giftProductCategories.count]];
    [LOCALMANAGER saveValueToUserDefaults:KEY_COUNT_APPLY_CATEGORY Value:[NSString stringWithFormat:@"%d",data.applyCategories.count]];
    [LOCALMANAGER saveValueToUserDefaults:KEY_COUNT_ATTENDANCE_CATEGORY Value:[NSString stringWithFormat:@"%d",data.attendanceCategories.count]];
    
    [LOCALMANAGER saveValueToUserDefaults:KEY_COUNT_USER Value:[NSString stringWithFormat:@"%d",data.users.count]];
