...
- (void)viewDidLoad
{
    ...
    tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, -35, MAINWIDTH , MAINHEIGHT) style:UITableViewStyleGrouped];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == CELL_MESSAGE) {
        ...
        messageCell.title.text = NSLocalizedString(@"pref_notification", nil);
