...
- (UIView *) tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    switch (section) {
        ...
        case 1:{
            ...
            header4.title.frame = CGRectMake(11, 5, 50, 30);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.section) {
        ...
        case 1:{
            ...
            //  tvRemarkCell.textView.backgroundColor = [UIColor lightGrayColor];
...
-(UIView*)setView {
    ...
    UIView *contView = [[UIView alloc] initWithFrame:CGRectMake(0, 40, MAINWIDTH - 100, 20)];
