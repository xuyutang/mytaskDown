...
//        }
        ...
        if ([f.value isEqual: FUNC_HOLIDAY_DES]) {
            NAMenuItem *item23 = [[NAMenuItem alloc] initWithTitle:@"任务下发"
                                                          iconFile:[NSString fontAwesomeIconStringForEnum:FACloudDownload]
                                                         iconColor:WT_RED
                                                    viewController:(APPDELEGATE).TaskNavCtrl];//
