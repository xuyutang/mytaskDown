    ...
    */
    ...
    for (Function* f in userFunc){
        ...
        if ([FUNC_HOLIDAY_DES isEqualToString:f.value]) {
            ...
            item10.image = [NSString fontAwesomeIconStringForEnum:FACloudDownload];
            item10.name = @"任务下发";
...
- (void) showCtrl:(int) funcid{
    switch (funcid){
        ...
        case FUNC_PAPER_POST:
            ...
            break;
        case FUNC_HOLIDAY :
            [appDelegate.drawerController setCenterViewController:appDelegate.TaskNavCtrl withCloseAnimation:YES completion:nil];
            break;
