...
- (void)viewDidLoad {
    ...
    UIImageView *listImageView = [[UIImageView alloc] initWithFrame:CGRectMake(100, 15, 30, 30)];
    [listImageView setImage:[UIImage imageNamed:@"ic_menu_approve"]];
    ...
    UIImageView *applyImageView = [[UIImageView alloc] initWithFrame:CGRectMake(60, 15, 30, 30)];
    [applyImageView setImage:[UIImage imageNamed:@"ic_menu_apply"]];
